...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1e9a25dd54afbeb2408c05f359a8aa64) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("eliom.server",
                               Some (OASISVersion.VGreaterEqual "4.0"));
                           FindlibPackage
                             ("batteries",
                               Some (OASISVersion.VGreaterEqual "2.2"));
                           FindlibPackage
                             ("macaque",
                               Some (OASISVersion.VGreaterEqual "0.6"));
                           FindlibPackage
                             ("pgocaml",
                               Some (OASISVersion.VGreaterEqual "2.0"));
                           FindlibPackage
                             ("lwt", Some (OASISVersion.VGreaterEqual "2.4"));
                           FindlibPackage
                             ("safepass",
                      ...
                      bs_byteopt =
                        [(OASISExpr.EBool true, ["-w"; "A-44-33-41"])];
                   ...
                   },
                   {
                      ...
                      lib_findlib_parent = Some "cumulus";
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "db";
                           FindlibPackage ("camomile", None);
                           FindlibPackage
                             ("markdown.html",
                               Some (OASISVersion.VGreaterEqual "0.1.1"))
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                  ...
                  },
                   {
                      ...
                      bs_data_files =
                        [
                           ...
                           ("../data/*.png", None);
                           ("../data/*.svg", None);
                           ("../_build/src/client/cumulus.js", None)
                        ];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "cumulus.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\184\153]\239\007\168\237A\145Y\223~\b)\242:";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
...
let () =
  ...
  let check_msg = function
    | "Cannot find source file matching module 'server/Client' in library cumulus" ->
        true
    | _ -> false
  in
  let def = !default in
